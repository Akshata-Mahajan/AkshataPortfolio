...
const AboutPage = () => {
  ...
  const totalVirtualInternships = "5+";
  ...
  const statsData = useMemo(
    () => [
      ...
      },
      {
        icon: Globe,
        color: "from-[#6366f1] to-[#a855f7]",
        value: totalVirtualInternships,
        label: "Virtual Internships",
        description: "Hands-on practical learning",
        animation: "fade-left",
      },
    ],
    [totalProjects, totalCertificates, totalVirtualInternships]
  );
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              A Computer Science undergrad passionate about full-stack development, data analytics, and building intuitive, impactful web solutions. I thrive on blending technology with creativity to craft accessible digital products. As PR Head of the ACM Student Chapter and ISR Lead, I’ve led high-impact initiatives, strengthened collaboration, and fostered community engagement—turning ideas into real-world outcomes.
            </p>
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a
                href="https://drive.google.com/drive/folders/12dW_11DYHPdOXSso8jZU3XMziW2xSynh"
