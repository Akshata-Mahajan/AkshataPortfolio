...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0 mt-6" data-aos="zoom-in" data-aos-delay="400">
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030014] overflow-hidden px-[5%] sm:px-[5%] lg:px-[10%] mb-10" id="Home">
